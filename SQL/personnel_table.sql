...
*************************************************************************************************************/
DROP SEQUENCE IF EXISTS MRT_DATA.PERSONNEL_SEQ;
...
ALTER TABLE MRT_DATA.PERSONNEL DROP CONSTRAINT IF EXISTS MRT_DATA.FK_PERSONNEL_ASSIGN;
ALTER TABLE MRT_DATA.PERSONNEL DROP CONSTRAINT IF EXISTS MRT_DATA.FK_PERSONNEL_HOME;
...
CREATE INDEX IF NOT EXISTS MRT_DATA.IDX_PERSONNEL_NM ON MRT_DATA.PERSONNEL(SURNAME,GIVEN_NAME,MIDDLE_NAME);
...
ALTER TABLE MRT_DATA.PERSONNEL ADD CONSTRAINT FK_PERSONNEL_ASSIGN FOREIGN KEY (ASSIGNED_UNIT) REFERENCES MRT_DATA.UNIT(UNIT_ID) ON DELETE CASCADE;
ALTER TABLE MRT_DATA.PERSONNEL ADD CONSTRAINT FK_PERSONNEL_HOME   FOREIGN KEY (HOME_UNIT)     REFERENCES MRT_DATA.UNIT(UNIT_ID) ON DELETE CASCADE;
/*************************************************************************************************************
**  End: Personnel Table
*************************************************************************************************************/
